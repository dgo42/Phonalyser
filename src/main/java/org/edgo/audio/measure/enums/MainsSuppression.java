...
/** Mains-hum (50/60 Hz + harmonics) suppression method.  {@link #NONE} =
 *  pass-through; {@link #IIR_COMB} = frequency-tracked IIR comb;
 *  {@link #SYNC_SUBTRACT} = period-locked synchronous subtraction;
 *  {@link #LMS} = adaptive LMS line canceller. */
public enum MainsSuppression {
    ...
    public static final String[] LABELS = { "None", "IIR comb", "Sync subtract", "LMS canceller" };
